...
func FileUpload(ctx context.Context, clt *core.SDKClient, req *customaudience.FileUploadRequest, accessToken string) (string, error) {
	var resp customaudience.FileUploadResponse
