...
// CustomAudienceRuleCreateRequest 通过规则创建受众 API Request
...
func (r *CustomAudienceRuleCreateRequest) Encode() []byte {
	return util.JSONMarshal(r)
}

// CustomAudienceRuleCreateResponse 通过规则创建受众 API Response
type CustomAudienceRuleCreateResponse struct {
	model.BaseResponse
	Data struct {
