...
// GetResponse 获取受众详情 API Response
type GetResponse struct {
	model.BaseResponse
	Data struct {
		// List 受众群体详情列表
		List []AudienceWithHistory `json:"list,omitempty"`
	} `json:"data"`
}

type AudienceWithHistory struct {
	// AudienceDetails 受众群体数据
	AudienceDetails *Audience `json:"audience_details,omitempty"`
