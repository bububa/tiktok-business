...
// DirectReplyGetRequest Get the Comment-to-Message setting of a Business Account API Request
type DirectReplyGetRequest struct {
...
func (r *DirectReplyGetRequest) Encode() string {
	values := util.NewURLValues()
	values.Set("business_id", r.BusinessID)
	values.Set("direct_reply_type", string(r.DirectReplyType))
	ret := values.Encode()
	util.ReleaseURLValues(values)
	return ret
}

// DirectReplyGetResponse Get the Comment-to-Message setting of a Business Account API Response
type DirectReplyGetResponse struct {
	model.BaseResponse
	Data *DirectReplyGetResult `json:"data,omitempty"`
}

type DirectReplyGetResult struct {
	// BusinessID Application specific unique identifier for the TikTok Business Account.
	// Pass the value of the open_id field returned in the response of /tt_user/oauth2/token/ to this field.
	BusinessID string `json:"business_id,omitempty"`
	// DirectReplyType The type of direct reply.
