...
// AutoMessageDeleteRequest Delete the automatic message for a Business Account API Request
type AutoMessageDeleteRequest struct {
...
func (r *AutoMessageDeleteRequest) Encode() []byte {
