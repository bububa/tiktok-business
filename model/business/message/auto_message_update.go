...
// AutoMessageUpdateRequest Update the automatic message for a Business Account API Request
type AutoMessageUpdateRequest struct {
...
func (r *AutoMessageUpdateRequest) Encode() []byte {
	return util.JSONMarshal(r)
}

// AutoMessageUpdateResponse Update an automatic message for a Business Account API Response
type AutoMessageUpdateResponse struct {
	model.BaseResponse
	Data struct {
